...
CREATE TABLE domains (ResourceId BIGINT NOT NULL, Name VARCHAR(255) NOT NULL UNIQUE, Type INTEGER NOT NULL, PortalId BIGINT NOT NULL, PRIMARY KEY (ResourceId))
