...
CREATE TABLE portals (ResourceId BIGINT NOT NULL, Content LONGTEXT NOT NULL, shared TINYINT(1) default 0, Title VARCHAR(255) NOT NULL, ThumbnailId BIGINT, UserId BIGINT NOT NULL, PRIMARY KEY (ResourceId))
